...
namespace ProjectA_ConsoleCore.Controller
{
    public class Controller
    {
        ...
        public Controller()
        {
            model.ProblemAddedNotify += model.NotifyStudent;
        }
        ...
        private void AddProblem()
        {
            ...
            var problem = new Problem() {Title = title, Text = text, TestCases = cases, Point = point, Download = download, Deadline = deadline};
